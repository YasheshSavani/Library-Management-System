...
class Mainmenu(tk.Frame):
    def __init__(self,parent,controller):
        ...
        self.search_image = tk.PhotoImage(file="images/bookshelf.png")
        ...
        self.renew_book.place(x=300, y=250)

        # self.profile_image = tk.PhotoImage(file="images/bookshelf.png")
        # self.profile = tk.Button(self, image=self.profile_image, text="Administrator", font=('Verdana', 16), compound='left',height=50, width=250,fg='green',command= lambda: controller.show_frame(Admin.Adminpage))
        # self.profile.place(x=300, y=250)

        self.return_image = tk.PhotoImage(file="images/bill.png" )
        self.return_books = tk.Button(self, image=self.return_image, text="Return Book", font=('Verdana', 16), compound='left',height=50, width=250,fg='grey')
        ...
        self.logout = tk.Button(self, image=self.logout_image, text="Logout", font=('Verdana', 16),compound='left',height=50, width=250,command= lambda :self.logout_button(),fg='black')
        self.logout.place(x=300, y=450)

        self.exit_image = tk.PhotoImage(file="images/bookshelf.png")
        self.exit = tk.Button(self, image=self.exit_image, text="Exit Accounts", font=('Verdana', 16),compound='left',height=50, width=250,command= lambda :quit(),fg='black')
